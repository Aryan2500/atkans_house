            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="table-responsive">
                        <table id="heroTable" class="display table dataTable table-striped table-bordered"
                            data-title="Hero Image List">
                            <thead>
                                <tr>
                                    <th>#</th>
                                    <th>Name</th>
                            ...
                            <tbody>
                                @foreach ($heros as $index => $product)
                                    <tr>
                                        <td>{{ $index + 1 }}</td>
                                        <td>{{ $product->name }}</td>
                                        ...
                                        <td>
                                            <a href="{{ route('hero.edit', $product->id) }}" class="btn btn-sm btn-info"
                                                title="Edit">
                                                <i class="fa fa-pen"></i>
                                            </a>
                        ...
                        <div class="mt-3">
                            <a href="{{ route('hero.create') }}" class="btn btn-success">
                                + Add New Hero Image
                            </a>
                        </div>
                    </div>
