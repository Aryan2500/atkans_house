                ...
                <div class="card-body">
                    <form class="needs-validation" novalidate method="POST" enctype="multipart/form-data"
                        ...
                        <div class="form-group form-check mt-3">
                            ...
                            <label class="form-check-label" for="is_free">All Notes Free?</label>
                        </div>
                        ...
                        <button class="btn btn-success btn-block" type="submit">📥 Upload All Notes</button>
                    </form>
                </div>
            </div>
        </div>
